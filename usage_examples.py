...
async def example_1_natural_language():
    ...
    print("\n" + "="*60)
    print("EXAMPLE 1: Natural Language → Execution Plan")
    print("="*60 + "\n")
...
async def example_3_cost_comparison():
    ...
    print(f"  - Latency: ~5-10s per receipt")
    ...
    print(f"  - Latency: ~2-4s per receipt")
    
    savings = ((gpt4o_total - two_model_total) / gpt4o_total) * 100
    print(f"\n💰 Savings: ${gpt4o_total - two_model_total:.2f} ({savings:.1f}%)")
    print(f"⚡ Speed improvement: ~2x faster")
...
async def example_4_hybrid_plan():
    ...
    print("Plan uses:")
    print("  ✓ MCP Workers (OCR, parsing)")
    print("  ✓ Function Calls (statistics)")
    print("  ✓ Code Execution (custom logic)")
...
async def main():
    ...
    print("\n\nℹ️  Examples 1, 2, 4 require configuration:")
