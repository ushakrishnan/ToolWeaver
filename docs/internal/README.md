...
This folder contains **private planning documents** that are **NOT** included in the public repository.
...
*Keep this folder private. Share only with trusted advisors/partners.*
