...
class ToolCache:
    ...
    def get_catalog(self, catalog_hash: str) -> Optional[Dict]:
    ...
    def get_search_results(self, query_hash: str, catalog_version: str, top_k: int) -> Optional[list]:
    ...
    def get_tool(self, tool_name: str, version: str) -> Optional[Dict]:
