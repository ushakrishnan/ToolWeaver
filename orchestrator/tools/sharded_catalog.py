...
class ShardedCatalog:
    ...
    def __init__(self):
        ...
        self._tool_count_by_domain: Dict[str, int] = {domain: 0 for domain in DOMAIN_KEYWORDS.keys()}
    ...
    def get_shard(self, domain: str) -> Optional[ToolCatalog]:
    ...
    def detect_domain(self, query: str) -> Optional[str]:
        ...
        domain_scores: Dict[str, int] = {domain: 0 for domain in DOMAIN_KEYWORDS.keys()}
